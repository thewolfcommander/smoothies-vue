<template>
    ...
    <div class="add-smoothie container">
        <h2 class="center-align indigo-text">Add a smoothie</h2>
        <form @submit.prevent="addSmoothie">
            <div class="field title">
                <label for="title">Smoothie Title</label>
                <input type="text" name="title" v-model="title" placeholder="Enter the smoothie title ...">
                <small class="show-text">Adding Smoothie with name: <strong class="indigo-text">{{ title }}</strong></small>
            </div>
